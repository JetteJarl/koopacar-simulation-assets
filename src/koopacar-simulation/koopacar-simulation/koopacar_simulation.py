"""
Edit:
ROS 2 node to spawn KoopaCar with some arbitrarily placed cones. The implementation is based on and mostly copied from
the implementation of a ROS 2 node to spawn a mobile robot inside a warehouse.
Author of original ROS 2 node:
...
def main():
    ...
    sdf_file_path = os.path.join(
        get_package_share_directory("koopacar-simulation"), "models",
        "koopacar", "model.sdf")
